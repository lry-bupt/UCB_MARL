...
SINR_k6_SN{} = (order_k6_SN{}_positive**2*p_k6_SN{})/((np.linalg.norm(w_k6_SN{}.conj().T.dot(h_k6_SN{})))**2*p_k6_SN{}+(np.linalg.norm(w_k6_SN{}.conj().T.dot(h_k6_SN{})))**2*p_k6_SN{}+10**(-9))'''.format(order_k6_index[2]+4,order_k6_index[2]+4,order_k6_index[2]+4,order_k6_index[1]+4,order_k6_index[1]+4,order_k6_index[1]+4,order_k6_index[1]+4,order_k6_index[2]+4,order_k6_index[2]+4,order_k6_index[0]+4,order_k6_index[0]+4,order_k6_index[0]+4,order_k6_index[0]+4,order_k6_index[2]+4,order_k6_index[2]+4,order_k6_index[0]+4,order_k6_index[1]+4,order_k6_index[1]+4))
            ...
            if k1_done_label == 0:
             # observation_k12_= observation_k1_ + observation_k2_*xy_squre*xy_squre
                 ...
                 b_k1_done = 0.000001*math.sqrt(h_count_done**3*math.log(xy_squre*xy_squre*ACTION_SHAPE*n_count_done*h_count_done/pho_k1)/(N_k1_hnsa[observation_k1, action_k1, h_count]*1))
                 # print(reward_k1)
                 # RL learn from this transition
            ...
            if k2_done_label == 0:
                 ...
                 b_k2_done = 0.000001*math.sqrt(h_count_done**3*math.log(xy_squre*xy_squre*ACTION_SHAPE*n_count_done*h_count_done/pho_k2)/(N_k2_hnsa[observation_k2, action_k2, h_count]*1))
                 # print(reward_k1)
                 # RL learn from this transition
                 # print(lr_k1, b_k1_done)
            ...
            # observation_k12_= observation_k1_ + observation_k2_*xy_squre*xy_squre
                ...
                # observation_k2 = observation_k2_
                # h_count_k2_done = h_count
                N_k6_hnsa[observation_k5, action_k5, h_count] = N_k6_hnsa[observation_k5, action_k5, h_count]+1
                lr_k6 = (h_count_done+1)/(h_count_done+N_k6_hnsa[observation_k5, action_k5, h_count])
                b_k6_done = 0.000001*math.sqrt(h_count_done**5*math.log(xy_squre*xy_squre*ACTION_SHAPE*n_count_done*h_count_done/pho_k6)/(N_k6_hnsa[observation_k5, action_k5, h_count]*C_K))
                RL6.learn(observation_k5, action_k5, reward_k5, observation_k5_, lr_k6, b_k6_done, done5)
            ...
            if k6_done_label == 0:
                ...
                N_k5_hnsa[observation_k6, action_k6, h_count] = N_k5_hnsa[observation_k6, action_k6, h_count]+1
                lr_k5 = (h_count_done+1)/(h_count_done+N_k5_hnsa[observation_k6, action_k6, h_count])
                b_k5_done = 0.000001*math.sqrt(h_count_done**3*math.log(xy_squre*xy_squre*ACTION_SHAPE*n_count_done*h_count_done/pho_k5)/(N_k5_hnsa[observation_k6, action_k6, h_count]*C_K))
                # print(reward_k6)
                # RL learn from this transition
                # print(lr_k6, b_k6_done)
                RL5.learn(observation_k6, action_k6, reward_k6, observation_k6_, lr_k5, b_k5_done, done6)
        ...
        ep_sum =( ep_reward_k5+(h_count_done-h_count_k5_done-1)*1+ep_reward_k6+(h_count_done-h_count_k6_done-1)*1)/1
