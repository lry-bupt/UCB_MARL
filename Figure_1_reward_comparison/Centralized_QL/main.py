...
for episode in range(n_count_done):
    ...
    for h_count in range(h_count_done):
        ...
        g_k1_SN1_LOS = math.sqrt(1/2)*np.array([1,math.exp(1)**(-1*1j*theta_k1_SN1), math.exp(1)**(-1*1j*theta_k1_SN1*2), math.exp(1)**(-1*1j*theta_k1_SN1*3), math.exp(1)**(-1*1j*theta_k1_SN1*4), math.exp(1)**(-1*1j*theta_k1_SN1*5), math.exp(1)**(-1*1j*theta_k1_SN1*6), math.exp(1)**(-1*1j*theta_k1_SN1*7)])
        g_k1_SN2_LOS = math.sqrt(1/2)*np.array([1,math.exp(1)**(-1*1j*theta_k1_SN2), math.exp(1)**(-1*1j*theta_k1_SN2*2), math.exp(1)**(-1*1j*theta_k1_SN2*3), math.exp(1)**(-1*1j*theta_k1_SN2*4), math.exp(1)**(-1*1j*theta_k1_SN2*5), math.exp(1)**(-1*1j*theta_k1_SN2*6), math.exp(1)**(-1*1j*theta_k1_SN2*7)])
        g_k1_SN3_LOS = math.sqrt(1/2)*np.array([1,math.exp(1)**(-1*1j*theta_k1_SN3), math.exp(1)**(-1*1j*theta_k1_SN3*2), math.exp(1)**(-1*1j*theta_k1_SN3*3), math.exp(1)**(-1*1j*theta_k1_SN3*4), math.exp(1)**(-1*1j*theta_k1_SN3*5), math.exp(1)**(-1*1j*theta_k1_SN3*6), math.exp(1)**(-1*1j*theta_k1_SN3*7)])
        g_k1_SN4_LOS = math.sqrt(1/2)*np.array([1,math.exp(1)**(-1*1j*theta_k1_SN4), math.exp(1)**(-1*1j*theta_k1_SN4*2), math.exp(1)**(-1*1j*theta_k1_SN4*3), math.exp(1)**(-1*1j*theta_k1_SN4*4), math.exp(1)**(-1*1j*theta_k1_SN4*5), math.exp(1)**(-1*1j*theta_k1_SN4*6), math.exp(1)**(-1*1j*theta_k1_SN4*7)])
        g_k1_SN5_LOS = math.sqrt(1/2)*np.array([1,math.exp(1)**(-1*1j*theta_k1_SN5), math.exp(1)**(-1*1j*theta_k1_SN5*2), math.exp(1)**(-1*1j*theta_k1_SN5*3), math.exp(1)**(-1*1j*theta_k1_SN5*4), math.exp(1)**(-1*1j*theta_k1_SN5*5), math.exp(1)**(-1*1j*theta_k1_SN5*6), math.exp(1)**(-1*1j*theta_k1_SN5*7)])
        g_k1_SN6_LOS = math.sqrt(1/2)*np.array([1,math.exp(1)**(-1*1j*theta_k1_SN6), math.exp(1)**(-1*1j*theta_k1_SN6*2), math.exp(1)**(-1*1j*theta_k1_SN6*3), math.exp(1)**(-1*1j*theta_k1_SN6*4), math.exp(1)**(-1*1j*theta_k1_SN6*5), math.exp(1)**(-1*1j*theta_k1_SN6*6), math.exp(1)**(-1*1j*theta_k1_SN6*7)])
        ...
        #communication model
        H_k1 = np.array([h_k1_SN1.T, h_k1_SN2.T, h_k1_SN3.T, h_k1_SN4.T, h_k1_SN5.T, h_k1_SN6.T]).T
        # try:
        ...
        #     W_bar_k1 = H_k1.dot(lg.inv(H_k1.conj().T.dot(H_k1)))
        W_bar_k1 = H_k1.dot(lg.inv(H_k1.conj().T.dot(H_k1)))
        w_k1_SN1 = W_bar_k1[:, 0]/(np.linalg.norm(W_bar_k1[:, 0]))
        w_k1_SN2 = W_bar_k1[:, 1]/(np.linalg.norm(W_bar_k1[:, 1]))
        ...
        g_k2_SN4_LOS = math.sqrt(1/2)*np.array([1,math.exp(1)**(-1*1j*theta_k2_SN4), math.exp(1)**(-1*1j*theta_k2_SN4*2), math.exp(1)**(-1*1j*theta_k2_SN4*3), math.exp(1)**(-1*1j*theta_k2_SN4*4), math.exp(1)**(-1*1j*theta_k2_SN4*5), math.exp(1)**(-1*1j*theta_k2_SN4*6), math.exp(1)**(-1*1j*theta_k2_SN4*7)])
        g_k2_SN5_LOS = math.sqrt(1/2)*np.array([1,math.exp(1)**(-1*1j*theta_k2_SN5), math.exp(1)**(-1*1j*theta_k2_SN5*2), math.exp(1)**(-1*1j*theta_k2_SN5*3), math.exp(1)**(-1*1j*theta_k2_SN5*4), math.exp(1)**(-1*1j*theta_k2_SN5*5), math.exp(1)**(-1*1j*theta_k2_SN5*6), math.exp(1)**(-1*1j*theta_k2_SN5*7)])
        g_k2_SN6_LOS = math.sqrt(1/2)*np.array([1,math.exp(1)**(-1*1j*theta_k2_SN6), math.exp(1)**(-1*1j*theta_k2_SN6*2), math.exp(1)**(-1*1j*theta_k2_SN6*3), math.exp(1)**(-1*1j*theta_k2_SN6*4), math.exp(1)**(-1*1j*theta_k2_SN6*5), math.exp(1)**(-1*1j*theta_k2_SN6*6), math.exp(1)**(-1*1j*theta_k2_SN6*7)])
        g_k2_SN1_LOS = math.sqrt(1/2)*np.array([1,math.exp(1)**(-1*1j*theta_k2_SN1), math.exp(1)**(-1*1j*theta_k2_SN1*2), math.exp(1)**(-1*1j*theta_k2_SN1*3), math.exp(1)**(-1*1j*theta_k2_SN1*4), math.exp(1)**(-1*1j*theta_k2_SN1*5), math.exp(1)**(-1*1j*theta_k2_SN1*6), math.exp(1)**(-1*1j*theta_k2_SN1*7)])
        g_k2_SN2_LOS = math.sqrt(1/2)*np.array([1,math.exp(1)**(-1*1j*theta_k2_SN2), math.exp(1)**(-1*1j*theta_k2_SN2*2), math.exp(1)**(-1*1j*theta_k2_SN2*3), math.exp(1)**(-1*1j*theta_k2_SN2*4), math.exp(1)**(-1*1j*theta_k2_SN2*5), math.exp(1)**(-1*1j*theta_k2_SN2*6), math.exp(1)**(-1*1j*theta_k2_SN2*7)])
        g_k2_SN3_LOS = math.sqrt(1/2)*np.array([1,math.exp(1)**(-1*1j*theta_k2_SN3), math.exp(1)**(-1*1j*theta_k2_SN3*2), math.exp(1)**(-1*1j*theta_k2_SN3*3), math.exp(1)**(-1*1j*theta_k2_SN3*4), math.exp(1)**(-1*1j*theta_k2_SN3*5), math.exp(1)**(-1*1j*theta_k2_SN3*6), math.exp(1)**(-1*1j*theta_k2_SN3*7)])
        ...
        #communication model
        H_k2 = np.array([h_k2_SN4.T, h_k2_SN5.T, h_k2_SN6.T, h_k2_SN1.T, h_k2_SN2.T, h_k2_SN3.T]).T
        # try:
        ...
        #     W_bar_k2 = H_k2.dot(lg.inv(H_k2.conj().T.dot(H_k2)))
        W_bar_k2 = H_k2.dot(lg.inv(H_k2.conj().T.dot(H_k2)))
        w_k2_SN4 = W_bar_k2[:, 0]/(np.linalg.norm(W_bar_k2[:, 0]))
        w_k2_SN5 = W_bar_k2[:, 1]/(np.linalg.norm(W_bar_k2[:, 1]))
...
SINR_k2_SN{} = (order_k2_SN{}_positive**2*p_k2_SN{})/((np.linalg.norm(w_k2_SN{}.conj().T.dot(h_k2_SN{})))**2*p_k2_SN{}+(np.linalg.norm(w_k2_SN{}.conj().T.dot(h_k2_SN{})))**2*p_k2_SN{}+10**(-9))'''.format(order_k2_index[2]+4,order_k2_index[2]+4,order_k2_index[2]+4,order_k2_index[1]+4,order_k2_index[1]+4,order_k2_index[1]+4,order_k2_index[1]+4,order_k2_index[2]+4,order_k2_index[2]+4,order_k2_index[0]+4,order_k2_index[0]+4,order_k2_index[0]+4,order_k2_index[0]+4,order_k2_index[2]+4,order_k2_index[2]+4,order_k2_index[0]+4,order_k2_index[1]+4,order_k1_index[1]+4))
        ...
        reward_k1 = max(0, ((- d_k1_destination)/(d_k1_destination_max))*(1)+(0.002)*min((R_k1_SN1+R_k1_SN2+R_k1_SN3),100))
        reward_k2 = max(0, ((- d_k2_destination)/(d_k2_destination_max))*(1)+(0.002)*min((R_k2_SN4+R_k2_SN5+R_k2_SN6),100))
    ...
    #print(episode, h_count, ep_reward_k12+(h_count_done-h_count)*reward_k12)
