...
Antenna_L = 2
ACTION_SHAPE = 5*20
h_count_array = [200,400,600]#ACTION_SHAPE = (5*20)**K
p_6 = np.arange(1, 7)
p_c63 = np.zeros([20,3])
p_index = 0
P_SN_mav = 0.2
...
for dr_i in range(len(h_count_array)):
    # np.random.seed(seed_array[seed_i])
    h_count_done = h_count_array[dr_i]
    RL1 = QLearningTable(actions=list(range(ACTION_SHAPE)),  learning_rate=0.01, reward_decay=0.9, e_greedy=0.9)
    RL2 = QLearningTable(actions=list(range(ACTION_SHAPE)),  learning_rate=0.01, reward_decay=0.9, e_greedy=0.9)
    RL3 = QLearningTable(actions=list(range(ACTION_SHAPE)),  learning_rate=0.01, reward_decay=0.9, e_greedy=0.9)
    RL4 = QLearningTable(actions=list(range(ACTION_SHAPE)),  learning_rate=0.01, reward_decay=0.9, e_greedy=0.9)
    RL5 = QLearningTable(actions=list(range(ACTION_SHAPE)),  learning_rate=0.01, reward_decay=0.9, e_greedy=0.9)
    RL6 = QLearningTable(actions=list(range(ACTION_SHAPE)),  learning_rate=0.01, reward_decay=0.9, e_greedy=0.9)
    ...
    for episode in range(n_count_done):
        ...
        for h_count in range(h_count_done):
            ...
            if k1_done_label == 0:
                action_k1 = RL1.choose_action(str(observation_k1))
            if k2_done_label == 0:
                action_k2 = RL2.choose_action(str(observation_k2))
...
SINR_k2_SN{} = (order_k2_SN{}_positive**2*p_k2_SN{})/((np.linalg.norm(w_k2_SN{}.conj().T.dot(h_k2_SN{})))**2*p_k2_SN{}+(np.linalg.norm(w_k2_SN{}.conj().T.dot(h_k2_SN{})))**2*p_k2_SN{}+10**(-9))'''.format(order_k2_index[2]+4,order_k2_index[2]+4,order_k2_index[2]+4,order_k2_index[1]+4,order_k2_index[1]+4,order_k2_index[1]+4,order_k2_index[1]+4,order_k2_index[2]+4,order_k2_index[2]+4,order_k2_index[0]+4,order_k2_index[0]+4,order_k2_index[0]+4,order_k2_index[0]+4,order_k2_index[2]+4,order_k2_index[2]+4,order_k2_index[0]+4,order_k2_index[1]+4,order_k2_index[1]+4))
            ...
            reward_k1 = (0.00000)*min((R_k1_SN1+R_k1_SN2+R_k1_SN3),50)
            reward_k2 = (0.00000)*min((R_k2_SN4+R_k2_SN5+R_k2_SN6),50)
            ...
            #print('2', (0.00000)*min((R_k1_SN1+R_k1_SN2+R_k1_SN3),100))
            ...
            if k3_done_label == 0:
                action_k3 = RL3.choose_action(str(observation_k3))
            if k4_done_label == 0:
                action_k4 = RL4.choose_action(str(observation_k4))
...
SINR_k4_SN{} = (order_k4_SN{}_positive**2*p_k4_SN{})/((np.linalg.norm(w_k4_SN{}.conj().T.dot(h_k4_SN{})))**2*p_k4_SN{}+(np.linalg.norm(w_k4_SN{}.conj().T.dot(h_k4_SN{})))**2*p_k4_SN{}+10**(-9))'''.format(order_k4_index[2]+4,order_k4_index[2]+4,order_k4_index[2]+4,order_k4_index[1]+4,order_k4_index[1]+4,order_k4_index[1]+4,order_k4_index[1]+4,order_k4_index[2]+4,order_k4_index[2]+4,order_k4_index[0]+4,order_k4_index[0]+4,order_k4_index[0]+4,order_k4_index[0]+4,order_k4_index[2]+4,order_k4_index[2]+4,order_k4_index[0]+4,order_k4_index[1]+4,order_k4_index[1]+4))
            ...
            reward_k3 = (0.00000)*min((R_k3_SN1+R_k3_SN2+R_k3_SN3),50)
            reward_k4 = (0.00000)*min((R_k4_SN4+R_k4_SN5+R_k4_SN6),50)
            ...
            #print('2', (0.00000)*min((R_k3_SN1+R_k3_SN2+R_k3_SN3),100))
            ...
            if done4 or k4_done_label==1:
                reward_k4 = 1
            # print((0.00000)*min((R_k3_SN1+R_k3_SN2+R_k3_SN3),50),reward_k2,reward_k3, reward_k4)
            # if done:
            #     if label_done==0:
            ...
            # RL choose action based on observation_k3
            if k5_done_label == 0:
                action_k5 = RL5.choose_action(str(observation_k5))
            if k6_done_label == 0:
                action_k6 = RL6.choose_action(str(observation_k6))
            # action_k3 = action_k32%ACTION_SHAPE_single
            # action_k4 = int(action_k32/ACTION_SHAPE_single)
...
SINR_k6_SN{} = (order_k6_SN{}_positive**2*p_k6_SN{})/((np.linalg.norm(w_k6_SN{}.conj().T.dot(h_k6_SN{})))**2*p_k6_SN{}+(np.linalg.norm(w_k6_SN{}.conj().T.dot(h_k6_SN{})))**2*p_k6_SN{}+10**(-9))'''.format(order_k6_index[2]+4,order_k6_index[2]+4,order_k6_index[2]+4,order_k6_index[1]+4,order_k6_index[1]+4,order_k6_index[1]+4,order_k6_index[1]+4,order_k6_index[2]+4,order_k6_index[2]+4,order_k6_index[0]+4,order_k6_index[0]+4,order_k6_index[0]+4,order_k6_index[0]+4,order_k6_index[2]+4,order_k6_index[2]+4,order_k6_index[0]+4,order_k6_index[1]+4,order_k6_index[1]+4))
            ...
            reward_k5 = (0.00000)*min((R_k5_SN1+R_k5_SN2+R_k5_SN3),50)
            reward_k6 = (0.00000)*min((R_k6_SN4+R_k6_SN5+R_k6_SN6),50)
            ...
            if k1_done_label == 0:
             # observation_k12_= observation_k1_ + observation_k2_*xy_squre*xy_squre
                 ...
                 RL1.learn(str(observation_k1), action_k1, reward_k1, str(observation_k1_))
                 ...
                 b_k3_done = 0.000001*math.sqrt(h_count_done**3*math.log(xy_squre*xy_squre*ACTION_SHAPE*n_count_done*h_count_done/pho_k3)/(N_k3_hnsa[observation_k1, action_k1, h_count]*C_K))
                  ...
                  # RL learn from this transition
                  # print(lr_k1, b_k1_done)
                 RL3.learn(str(observation_k1), action_k1, reward_k1, str(observation_k1_))
                 ...
                 b_k5_done = 0.000001*math.sqrt(h_count_done**3*math.log(xy_squre*xy_squre*ACTION_SHAPE*n_count_done*h_count_done/pho_k5)/(N_k5_hnsa[observation_k1, action_k1, h_count]*C_K))
                  ...
                  # RL learn from this transition
                  # print(lr_k1, b_k1_done)
                 RL5.learn(str(observation_k1), action_k1, reward_k1, str(observation_k1_))
            ...
            if k2_done_label == 0:
                 ...
                 # RL learn from this transition
                 # print(lr_k1, b_k1_done)
                 RL2.learn(str(observation_k2), action_k2, reward_k2, str(observation_k2_))
                 ...
                 RL4.learn(str(observation_k2), action_k2, reward_k2, str(observation_k2_))
                 ...
                 RL6.learn(str(observation_k2), action_k2, reward_k2, str(observation_k2_))
                 # ep_reward_k1 += reward_k1
                 # observation_k2 = observation_k2_
                 # h_count_k1_done = h_count
            ...
            if k3_done_label == 0:
             # observation_k12_= observation_k1_ + observation_k2_*xy_squre*xy_squre
                 ...
                 RL3.learn(str(observation_k3), action_k3, reward_k3, str(observation_k3_))
                 ...
                 b_k1_done = 0.000001*math.sqrt(h_count_done**3*math.log(xy_squre*xy_squre*ACTION_SHAPE*n_count_done*h_count_done/pho_k1)/(N_k1_hnsa[observation_k3, action_k3, h_count]*C_K))
                  ...
                  # RL learn from this transition
                  # print(lr_k3, b_k3_done)
                 RL1.learn(str(observation_k3), action_k3, reward_k3, str(observation_k3_))
                 ...
                 b_k5_done = 0.000001*math.sqrt(h_count_done**3*math.log(xy_squre*xy_squre*ACTION_SHAPE*n_count_done*h_count_done/pho_k5)/(N_k5_hnsa[observation_k3, action_k3, h_count]*C_K))
                  ...
                  # RL learn from this transition
                  # print(lr_k3, b_k3_done)
                 RL5.learn(str(observation_k3), action_k3, reward_k3, str(observation_k3_))
            ...
            if k4_done_label == 0:
                 ...
                 # RL learn from this transition
                 # print(lr_k1, b_k1_done)
                 RL4.learn(str(observation_k4), action_k4, reward_k4, str(observation_k4_))
                 ...
                 RL2.learn(str(observation_k4), action_k4, reward_k4, str(observation_k4_))
                  # ep_reward_k1 += reward_k1
                  # observation_k4 = observation_k4_
                  # h_count_k1_done = h_count
                 ...
                 b_k6_done = 0.000001*math.sqrt(h_count_done**3*math.log(xy_squre*xy_squre*ACTION_SHAPE*n_count_done*h_count_done/pho_k6)/(N_k6_hnsa[observation_k4, action_k4, h_count]*C_K))
                  ...
                  # RL learn from this transition
                  # print(lr_k6, b_k6_done)
                 RL6.learn(str(observation_k4), action_k4, reward_k4, str(observation_k4_))
            ...
            # observation_k12_= observation_k1_ + observation_k2_*xy_squre*xy_squre
                ...
                RL5.learn(str(observation_k5), action_k5, reward_k5, str(observation_k5_))
                ...
                RL1.learn(str(observation_k5), action_k5, reward_k5, str(observation_k5_))
                # ep_reward_k1 += reward_k2
                # observation_k2 = observation_k2_
                # h_count_k2_done = h_count
                ...
                RL3.learn(str(observation_k5), action_k5, reward_k5, str(observation_k5_))
            ...
            if k6_done_label == 0:
                ...
                # RL learn from this transition
                # print(lr_k1, b_k1_done)
                RL6.learn(str(observation_k6), action_k6, reward_k6, str(observation_k6_))
                ...
                # RL learn from this transition
                # print(lr_k2, b_k2_done)
                RL2.learn(str(observation_k6), action_k6, reward_k6, str(observation_k6_))
                ...
                # RL learn from this transition
                # print(lr_k6, b_k6_done)
                RL4.learn(str(observation_k6), action_k6, reward_k6, str(observation_k6_))
