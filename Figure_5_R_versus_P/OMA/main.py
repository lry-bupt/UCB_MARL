...
for p_count in range(len(P_SN_mav_array)):
    ...
    N_k9_hnsa = np.zeros([xy_squre*xy_squre, ACTION_SHAPE, h_count_done])
    ...
    for episode in range(n_count_done):
        ...
        for h_count in range(h_count_done):
            ...
            g_k1_SN1_LOS = math.sqrt(1/2)*np.array([1,math.exp(1)**(-1*1j*theta_k1_SN1), math.exp(1)**(-1*1j*theta_k1_SN1*2)])
            g_k1_SN2_LOS = math.sqrt(1/2)*np.array([1,math.exp(1)**(-1*1j*theta_k1_SN2), math.exp(1)**(-1*1j*theta_k1_SN2*2)])
            g_k1_SN3_LOS = math.sqrt(1/2)*np.array([1,math.exp(1)**(-1*1j*theta_k1_SN3), math.exp(1)**(-1*1j*theta_k1_SN3*2)])
            g_k1_SN4_LOS = math.sqrt(1/2)*np.array([1,math.exp(1)**(-1*1j*theta_k1_SN4), math.exp(1)**(-1*1j*theta_k1_SN4*2)])
            g_k1_SN5_LOS = math.sqrt(1/2)*np.array([1,math.exp(1)**(-1*1j*theta_k1_SN5), math.exp(1)**(-1*1j*theta_k1_SN5*2)])
            g_k1_SN6_LOS = math.sqrt(1/2)*np.array([1,math.exp(1)**(-1*1j*theta_k1_SN6), math.exp(1)**(-1*1j*theta_k1_SN6*2)])
            ...
            #communication model
            H_k1_PART1 = np.array([h_k1_SN1[0],h_k1_SN1[1],h_k1_SN1[2],h_k1_SN2[0],h_k1_SN2[1],h_k1_SN2[2],h_k1_SN3[0],h_k1_SN3[1],h_k1_SN3[2]]).T
            H_k1_PART2 = np.array([h_k1_SN4[0],h_k1_SN4[1],h_k1_SN4[2],h_k1_SN5[0],h_k1_SN5[1],h_k1_SN5[2],h_k1_SN6[0],h_k1_SN6[1],h_k1_SN6[2]]).T
            ...
            g_k1_SN7_LOS = math.sqrt(1/2)*np.array([1,math.exp(1)**(-1*1j*theta_k1_SN7), math.exp(1)**(-1*1j*theta_k1_SN7*2)])
            g_k1_SN8_LOS = math.sqrt(1/2)*np.array([1,math.exp(1)**(-1*1j*theta_k1_SN8), math.exp(1)**(-1*1j*theta_k1_SN8*2)])
            g_k1_SN9_LOS = math.sqrt(1/2)*np.array([1,math.exp(1)**(-1*1j*theta_k1_SN9), math.exp(1)**(-1*1j*theta_k1_SN9*2)])
            ...
            H_k1_PART3 = np.array([h_k1_SN7[0],h_k1_SN7[1],h_k1_SN7[2],h_k1_SN8[0],h_k1_SN8[1],h_k1_SN8[2],h_k1_SN9[0],h_k1_SN9[1],h_k1_SN9[2]]).T
            
            #communication model
            H_k1 = np.array([H_k1_PART1, H_k1_PART2, H_k1_PART3]).T
            # try:
            ...
            w_k1_SN3=w_k1_k1[6:9]
            w_k1_SN2=w_k1_k1[3:6]
            w_k1_SN1=w_k1_k1[0:3]
            # w_check1 = np.linalg.norm(w_k1_SN1)
            # w_check2 = np.linalg.norm(w_k1_SN2)
            # w_check3 = np.linalg.norm(w_k1_SN3)
            ...
            g_k2_SN4_LOS = math.sqrt(1/2)*np.array([1,math.exp(1)**(-1*1j*theta_k2_SN4), math.exp(1)**(-1*1j*theta_k2_SN4*2)])
            g_k2_SN5_LOS = math.sqrt(1/2)*np.array([1,math.exp(1)**(-1*1j*theta_k2_SN5), math.exp(1)**(-1*1j*theta_k2_SN5*2)])
            g_k2_SN6_LOS = math.sqrt(1/2)*np.array([1,math.exp(1)**(-1*1j*theta_k2_SN6), math.exp(1)**(-1*1j*theta_k2_SN6*2)])
            g_k2_SN1_LOS = math.sqrt(1/2)*np.array([1,math.exp(1)**(-1*1j*theta_k2_SN1), math.exp(1)**(-1*1j*theta_k2_SN1*2)])
            g_k2_SN2_LOS = math.sqrt(1/2)*np.array([1,math.exp(1)**(-1*1j*theta_k2_SN2), math.exp(1)**(-1*1j*theta_k2_SN2*2)])
            g_k2_SN3_LOS = math.sqrt(1/2)*np.array([1,math.exp(1)**(-1*1j*theta_k2_SN3), math.exp(1)**(-1*1j*theta_k2_SN3*2)])
            ...
            g_k2_SN7_LOS = math.sqrt(1/2)*np.array([1,math.exp(1)**(-1*1j*theta_k2_SN7), math.exp(1)**(-1*1j*theta_k2_SN7*2)])
            g_k2_SN8_LOS = math.sqrt(1/2)*np.array([1,math.exp(1)**(-1*1j*theta_k2_SN8), math.exp(1)**(-1*1j*theta_k2_SN8*2)])
            g_k2_SN9_LOS = math.sqrt(1/2)*np.array([1,math.exp(1)**(-1*1j*theta_k2_SN9), math.exp(1)**(-1*1j*theta_k2_SN9*2)])
            ...
            H_k2_PART3 = np.array([h_k2_SN7[0],h_k2_SN7[1],h_k2_SN7[2],h_k2_SN8[0],h_k2_SN8[1],h_k2_SN8[2],h_k2_SN9[0],h_k2_SN9[1],h_k2_SN9[2]]).T
            #communication model
            H_k2_PART1 = np.array([h_k2_SN1[0],h_k2_SN1[1],h_k2_SN1[2],h_k2_SN2[0],h_k2_SN2[1],h_k2_SN2[2],h_k2_SN3[0],h_k2_SN3[1],h_k2_SN3[2]]).T
            H_k2_PART2 = np.array([h_k2_SN4[0],h_k2_SN4[1],h_k2_SN4[2],h_k2_SN5[0],h_k2_SN5[1],h_k2_SN5[2],h_k2_SN6[0],h_k2_SN6[1],h_k2_SN6[2]]).T
            
            #communication model
            H_k2 = np.array([H_k2_PART1, H_k2_PART2, H_k2_PART3]).T
            # try:
            ...
            w_k2_SN6=w_k2_k2[6:9]
            w_k2_SN5=w_k2_k2[3:6]
            w_k2_SN4=w_k2_k2[0:3]
            ...
            g_k7_SN4_LOS = math.sqrt(1/2)*np.array([1,math.exp(1)**(-1*1j*theta_k7_SN4), math.exp(1)**(-1*1j*theta_k7_SN4*2)])
            g_k7_SN5_LOS = math.sqrt(1/2)*np.array([1,math.exp(1)**(-1*1j*theta_k7_SN5), math.exp(1)**(-1*1j*theta_k7_SN5*2)])
            g_k7_SN6_LOS = math.sqrt(1/2)*np.array([1,math.exp(1)**(-1*1j*theta_k7_SN6), math.exp(1)**(-1*1j*theta_k7_SN6*2)])
            g_k7_SN1_LOS = math.sqrt(1/2)*np.array([1,math.exp(1)**(-1*1j*theta_k7_SN1), math.exp(1)**(-1*1j*theta_k7_SN1*2)])
            g_k7_SN2_LOS = math.sqrt(1/2)*np.array([1,math.exp(1)**(-1*1j*theta_k7_SN2), math.exp(1)**(-1*1j*theta_k7_SN2*2)])
            g_k7_SN3_LOS = math.sqrt(1/2)*np.array([1,math.exp(1)**(-1*1j*theta_k7_SN3), math.exp(1)**(-1*1j*theta_k7_SN3*2)])
            ...
            theta_k7_SN7 = math.exp(1)**(-1*1j*(math.pi*(x_SN7+xy_squre-x_7)/d_k7_SN7))
            theta_k7_SN8 = math.exp(1)**(-1*1j*(math.pi*(x_SN8+xy_squre-x_7)/d_k7_SN8))
            theta_k7_SN9 = math.exp(1)**(-1*1j*(math.pi*(x_SN9+xy_squre-x_7)/d_k7_SN9))
            g_k7_SN7_LOS = math.sqrt(1/2)*np.array([1,math.exp(1)**(-1*1j*theta_k7_SN7), math.exp(1)**(-1*1j*theta_k7_SN7*2)])
            g_k7_SN8_LOS = math.sqrt(1/2)*np.array([1,math.exp(1)**(-1*1j*theta_k7_SN8), math.exp(1)**(-1*1j*theta_k7_SN8*2)])
            g_k7_SN9_LOS = math.sqrt(1/2)*np.array([1,math.exp(1)**(-1*1j*theta_k7_SN9), math.exp(1)**(-1*1j*theta_k7_SN9*2)])
            ...
            H_k7_PART3 = np.array([h_k7_SN7[0],h_k7_SN7[1],h_k7_SN7[2],h_k7_SN8[0],h_k7_SN8[1],h_k7_SN8[2],h_k7_SN9[0],h_k7_SN9[1],h_k7_SN9[2]]).T
            #communication model
            H_k7_PART1 = np.array([h_k7_SN1[0],h_k7_SN1[1],h_k7_SN1[2],h_k7_SN2[0],h_k7_SN2[1],h_k7_SN2[2],h_k7_SN3[0],h_k7_SN3[1],h_k7_SN3[2]]).T
            H_k7_PART2 = np.array([h_k7_SN4[0],h_k7_SN4[1],h_k7_SN4[2],h_k7_SN5[0],h_k7_SN5[1],h_k7_SN5[2],h_k7_SN6[0],h_k7_SN6[1],h_k7_SN6[2]]).T
            
            #communication model
            H_k7 = np.array([H_k7_PART1, H_k7_PART2, H_k7_PART3]).T
            # try:
            ...
            # w_check3 = np.linalg.norm(w_k1_SN6)
            w_k7_SN9=w_k7_k7[6:9]
            w_k7_SN8=w_k7_k7[3:6]
            w_k7_SN7=w_k7_k7[0:3]
...
SINR_k7_SN{} = (order_k7_SN{}_positive**2*p_k7_SN{})/(10**(-9))
SINR_k7_SN{} = (order_k7_SN{}_positive**2*p_k7_SN{})/(10**(-9))'''.format(order_k7_index[2]+7,order_k7_index[2]+7,order_k7_index[2]+7,order_k7_index[1]+7,order_k7_index[1]+7,order_k7_index[1]+7,order_k7_index[0]+7,order_k7_index[0]+7,order_k7_index[0]+7))
            R_k7_SN7 = math.log((1+SINR_k7_SN7*3),2)/3
            R_k7_SN8 = math.log((1+SINR_k7_SN8*3),2)/3
            R_k7_SN9 = math.log((1+SINR_k7_SN9*3),2)/3
...
SINR_k8_SN{} = (order_k8_SN{}_positive**2*p_k8_SN{})/(10**(-9))
SINR_k8_SN{} = (order_k8_SN{}_positive**2*p_k8_SN{})/(10**(-9))'''.format(order_k8_index[2]+7,order_k8_index[2]+7,order_k8_index[2]+7,order_k8_index[1]+7,order_k8_index[1]+7,order_k8_index[1]+7,order_k8_index[0]+7,order_k8_index[0]+7,order_k8_index[0]+7))
            R_k8_SN7 = math.log((1+SINR_k8_SN7*3),2)/3
            R_k8_SN8 = math.log((1+SINR_k8_SN8*3),2)/3
            R_k8_SN9 = math.log((1+SINR_k8_SN9*3),2)/3
...
SINR_k9_SN{} = (order_k9_SN{}_positive**2*p_k9_SN{})/(10**(-9))
SINR_k9_SN{} = (order_k9_SN{}_positive**2*p_k9_SN{})/(10**(-9))'''.format(order_k9_index[2]+7,order_k9_index[2]+7,order_k9_index[2]+7,order_k9_index[1]+7,order_k9_index[1]+7,order_k9_index[1]+7,order_k9_index[0]+7,order_k9_index[0]+7,order_k9_index[0]+7))
            R_k9_SN7 = math.log((1+SINR_k9_SN7*3),2)/3
            R_k9_SN8 = math.log((1+SINR_k9_SN8*3),2)/3
            R_k9_SN9 = math.log((1+SINR_k9_SN9*3),2)/3
        ...
        R_sum =(ep_R_k1/(h_count_k1_done+1)+ep_R_k2/(h_count_k2_done+1)+ep_R_k3/(h_count_k3_done+1)+ep_R_k4/(h_count_k4_done+1)+ep_R_k5/(h_count_k5_done+1)+ep_R_k6/(h_count_k6_done+1)+ep_R_k7/(h_count_k7_done+1)+ep_R_k8/(h_count_k8_done+1)+ep_R_k9/(h_count_k9_done+1))/9
